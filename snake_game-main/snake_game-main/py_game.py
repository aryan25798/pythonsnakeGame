...
font = pygame.font.SysFont(None, 25, bold=True) # type: ignore
...
def gameLoop():
    ...
    while not gameExit:
        ...
        pygame.draw.rect(gameDisplay, red, [randomAppleX,randomAppleY,AppleThickness,AppleThickness]) # type: ignore
